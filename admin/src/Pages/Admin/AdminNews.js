    ...
    const handleDelete = async (id)=>{
        Swal.fire({
          ...
          if (result.isConfirmed) {
            try {
              axiosInstance.delete(`/product/deleteGuide/${id}`);
            } catch (err) {
              console.log(err);
            }
              Swal.fire({
        ...
        return(
            <div className="card_container" key={guide.id}><br/>
                    ...
                    <div className="col-container">
                        <Link to={`/viewGuide`} state={{ guide:guide }} onClick={scrollToTop}><iconbutton><img src={eye} className='grow'/></iconbutton></Link>
                        <Link to={`/updateGuide`} state={{ guide:guide }} onClick={scrollToTop}><iconbutton><img src={pencel} className='grow'/></iconbutton></Link>
                ...
                <div className='APcenter-container'>
                    <div className='APcontainer-2'>
                        ...
                        <div className='col-secondcontainer'>
                            <h1 className="h1Text">Guide</h1>
                            <p className='APwebtext'>manage and add new guide here</p>
                        </div>
